...
#웹 서ㅓ 시행 시나오는 도메인 주소(127.0.0.1:8000)은 기본값이므로 생략됨
#404에러 발생시 호출할 뷰 함수
handler404 = 'Django6.views.handler404'

urlpatterns = [
    #127.0.0.1:8000/admin
    path('admin/', admin.site.urls),
    #127.0.0.1:8000 으로 요청시 북마크에 있는 index함수가 호출
